...
```bash
git clone https://github.com/sepehrshapouri/sepehrshapouri.com.git minimal-dev-portfolio
...
If you're working on a different React project and want to reuse the custom components from this repository, visit [sepehrshapouri.com/components](https://sepehrshapouri.com/components) for installation instructions and component documentation.
